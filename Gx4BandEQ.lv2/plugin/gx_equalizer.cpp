...
void Gx_equalizer_::init_dsp_(uint32_t rate)
{
...
void Gx_equalizer_::connect_(uint32_t port,void* data)
{
...
void Gx_equalizer_::run_dsp_(uint32_t n_samples)
{
...
void Gx_equalizer_::connect_all__ports(uint32_t port, void* data)
{
  // connect the Ports used by the plug-in class
  connect_(port,data); 
...
void Gx_equalizer_::run(LV2_Handle instance, uint32_t n_samples)
{
  // run dsp
